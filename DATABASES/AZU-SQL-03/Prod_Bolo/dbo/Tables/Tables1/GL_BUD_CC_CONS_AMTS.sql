CREATE TABLE [dbo].[GL_BUD_CC_CONS_AMTS] (
    [subValueId]                  VARCHAR (255)   NOT NULL,
    [GL_BUD_CC_CONS_ACCTG_PER_ID] VARCHAR (255)   NULL,
...
GO
CREATE NONCLUSTERED INDEX [GL_BUD_CC_GL_BUD_CC_7383]
    ON [dbo].[GL_BUD_CC_CONS_AMTS]([GL_BUD_CC_CONS_ACCTG_PER_ID] ASC);
