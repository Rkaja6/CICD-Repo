CREATE TABLE [dbo].[GL_FCAST_ACCTG_PER] (
    [GL_FCAST_ACCTG_PER_ID] VARCHAR (255)   NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([GL_FCAST_ACCTG_PER_ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [GL_FCAST_ACCTG_PER_u2_id_in]
    ON [dbo].[GL_FCAST_ACCTG_PER]([u2_id] ASC);
