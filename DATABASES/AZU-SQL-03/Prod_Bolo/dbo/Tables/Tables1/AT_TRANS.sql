CREATE TABLE [dbo].[AT_TRANS] (
    ...
    [AT_BASIS_ACCT]             VARCHAR (13)    NULL,
    [AT_CC_ALLOC_ID]            VARCHAR (11)    NULL,
    [AT_DATE]                   VARCHAR (11)    NULL,
    [AT_PERSPECTIVE]            VARCHAR (12)    NULL,
    [AT_TRANS_INDEX]            VARCHAR (8)     NULL,
    [AT_TYPE]                   VARCHAR (8)     NULL,
    [BALANCING_AMT]             NUMERIC (19, 2) NULL,
    [BAL_SOURCE_TRANS_ID]       VARCHAR (8)     NULL,
    [CC_ALLOC_DATE]             DATETIME        NULL,
    [CC_ALLOC_ID]               VARCHAR (15)    NULL,
    [CNV_ID]                    VARCHAR (12)    NULL,
    ...
    [INS_AMTS]                  VARCHAR (8)     NULL,
    [INS_COMPANIES]             VARCHAR (8)     NULL,
    [INS_QTY1S]                 VARCHAR (8)     NULL,
