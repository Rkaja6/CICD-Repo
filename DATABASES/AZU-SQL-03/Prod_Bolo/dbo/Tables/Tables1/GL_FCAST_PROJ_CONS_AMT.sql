CREATE TABLE [dbo].[GL_FCAST_PROJ_CONS_AMT] (
    [subValueId]                      VARCHAR (255)   NOT NULL,
    [GL_FCAST_PROJ_CONS_ACCTG_PER_ID] VARCHAR (255)   NULL,
...
GO
CREATE NONCLUSTERED INDEX [GL_FCAST__GL_FCAST__82667]
    ON [dbo].[GL_FCAST_PROJ_CONS_AMT]([GL_FCAST_PROJ_CONS_ACCTG_PER_ID] ASC);
