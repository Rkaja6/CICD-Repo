CREATE TABLE [dbo].[PROD_MO_TANK] (
    [PROD_MO_TANK_ID]             VARCHAR (255)   NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([PROD_MO_TANK_ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [PROD_MO_TANK_u2_id_in]
    ON [dbo].[PROD_MO_TANK]([u2_id] ASC);
