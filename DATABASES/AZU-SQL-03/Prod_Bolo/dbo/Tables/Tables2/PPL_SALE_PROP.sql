CREATE TABLE [dbo].[PPL_SALE_PROP] (
    [PPL_SALE_PROP_ID]      VARCHAR (255)   NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([PPL_SALE_PROP_ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [PPL_SALE_PROP_u2_id_in]
    ON [dbo].[PPL_SALE_PROP]([u2_id] ASC);
