CREATE TABLE [dbo].[LocationInfo] (
    [locationinfo_id]   INT            IDENTITY (1, 1) NOT NULL,
    ...
    [GasPurchaser]      NVARCHAR (MAX) NULL,
    [OilPurchaser]      NVARCHAR (MAX) NULL,
    [LineNumber]        BIGINT         NULL,
    [WaterPurchaser]    NVARCHAR (MAX) NULL,
    [deleted]           BIT            NOT NULL,
    [reuseEmailList]    BIT            NULL,
    ...
    CONSTRAINT [PK_LocationInfo] PRIMARY KEY CLUSTERED ([locationinfo_id] ASC)
);
