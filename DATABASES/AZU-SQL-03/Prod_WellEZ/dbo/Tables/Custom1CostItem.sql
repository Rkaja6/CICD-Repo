CREATE TABLE [dbo].[Custom1CostItem] (
    [custom1costitem_id]    INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_Custom1CostItem] PRIMARY KEY CLUSTERED ([custom1costitem_id] ASC)
);
