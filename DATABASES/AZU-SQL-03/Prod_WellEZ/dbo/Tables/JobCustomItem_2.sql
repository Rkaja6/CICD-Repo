CREATE TABLE [dbo].[JobCustomItem_2] (
    [jobcustomitem_2_id] INT            IDENTITY (1, 1) NOT NULL,
    [well_id]            BIGINT         NULL,
    ...
    CONSTRAINT [PK_JobCustomItem_2] PRIMARY KEY CLUSTERED ([jobcustomitem_2_id] ASC)
);
