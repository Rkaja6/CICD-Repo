CREATE TABLE [dbo].[Custom4CostContingency] (
    [custom4costcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]                   BIGINT          NULL,
    ...
    CONSTRAINT [PK_Custom4CostContingency] PRIMARY KEY CLUSTERED ([custom4costcontingency_id] ASC)
);
