CREATE TABLE [dbo].[JobCustomItem_4] (
    [jobcustomitem_4_id] INT            IDENTITY (1, 1) NOT NULL,
    [well_id]            BIGINT         NULL,
    ...
    CONSTRAINT [PK_JobCustomItem_4] PRIMARY KEY CLUSTERED ([jobcustomitem_4_id] ASC)
);
