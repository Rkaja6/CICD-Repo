CREATE TABLE [dbo].[Custom3CostItem] (
    [custom3costitem_id]    INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_Custom3CostItem] PRIMARY KEY CLUSTERED ([custom3costitem_id] ASC)
);
