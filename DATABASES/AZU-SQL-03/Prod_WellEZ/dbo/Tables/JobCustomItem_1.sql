CREATE TABLE [dbo].[JobCustomItem_1] (
    [jobcustomitem_1_id] INT            IDENTITY (1, 1) NOT NULL,
    [well_id]            BIGINT         NULL,
    ...
    CONSTRAINT [PK_JobCustomItem_1] PRIMARY KEY CLUSTERED ([jobcustomitem_1_id] ASC)
);
