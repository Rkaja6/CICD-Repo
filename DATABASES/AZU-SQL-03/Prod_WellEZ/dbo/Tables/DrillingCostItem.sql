CREATE TABLE [dbo].[DrillingCostItem] (
    [drillingcostitem_id]   INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_DrillingCostItem] PRIMARY KEY CLUSTERED ([drillingcostitem_id] ASC)
);
