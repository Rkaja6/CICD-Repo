CREATE TABLE [dbo].[JobCustomItem_5] (
    [jobcustomitem_5_id] INT            IDENTITY (1, 1) NOT NULL,
    [well_id]            BIGINT         NULL,
    ...
    CONSTRAINT [PK_JobCustomItem_5] PRIMARY KEY CLUSTERED ([jobcustomitem_5_id] ASC)
);
