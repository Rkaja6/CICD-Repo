CREATE TABLE [dbo].[FacilitiesCostContingency] (
    [facilitiescostcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]                      BIGINT          NULL,
    ...
    CONSTRAINT [PK_FacilitiesCostContingency] PRIMARY KEY CLUSTERED ([facilitiescostcontingency_id] ASC)
);
