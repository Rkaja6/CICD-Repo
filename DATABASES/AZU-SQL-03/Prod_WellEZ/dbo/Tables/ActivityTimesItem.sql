CREATE TABLE [dbo].[ActivityTimesItem] (
    [activitytimesitem_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]              BIGINT          NULL,
    ...
    CONSTRAINT [PK_ActivityTimesItem] PRIMARY KEY CLUSTERED ([activitytimesitem_id] ASC)
);
