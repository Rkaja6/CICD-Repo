CREATE TABLE [dbo].[WorkoverCostContingency] (
    [workovercostcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]                    BIGINT          NULL,
    ...
    CONSTRAINT [PK_WorkoverCostContingency] PRIMARY KEY CLUSTERED ([workovercostcontingency_id] ASC)
);
