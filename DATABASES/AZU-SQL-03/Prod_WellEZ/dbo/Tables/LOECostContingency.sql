CREATE TABLE [dbo].[LOECostContingency] (
    [loecostcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_LOECostContingency] PRIMARY KEY CLUSTERED ([loecostcontingency_id] ASC)
);
