CREATE TABLE [dbo].[FacilitiesCostItem] (
    [facilitiescostitem_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_FacilitiesCostItem] PRIMARY KEY CLUSTERED ([facilitiescostitem_id] ASC)
);
