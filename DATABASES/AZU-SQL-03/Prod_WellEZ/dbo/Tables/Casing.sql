CREATE TABLE [dbo].[Casing] (
    [casing_id]          INT             IDENTITY (1, 1) NOT NULL,
    [well_id]            BIGINT          NULL,
    ...
    [StringLength_TDRKB] DECIMAL (19, 9) NULL,
    [reportTypeId]       BIGINT          NOT NULL,
    [Head_PSI]           DECIMAL (19, 9) NULL,
    [Comment]            NVARCHAR (MAX)  NULL,
    [CasingSheet]        NVARCHAR (MAX)  NULL,
    [HoleOD]             DECIMAL (19, 9) NULL,
    [HoleDepth]          DECIMAL (19, 9) NULL,
    CONSTRAINT [PK_Casing] PRIMARY KEY CLUSTERED ([casing_id] ASC)
);
