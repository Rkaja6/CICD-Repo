CREATE TABLE [dbo].[Custom2CostItem] (
    [custom2costitem_id]    INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_Custom2CostItem] PRIMARY KEY CLUSTERED ([custom2costitem_id] ASC)
);
