CREATE TABLE [dbo].[Custom5CostItem] (
    [custom5costitem_id]    INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_Custom5CostItem] PRIMARY KEY CLUSTERED ([custom5costitem_id] ASC)
);
