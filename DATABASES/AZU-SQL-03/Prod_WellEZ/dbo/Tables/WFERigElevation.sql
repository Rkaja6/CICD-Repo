CREATE TABLE [dbo].[WFERigElevation] (
    [wferigelevation_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]            BIGINT          NULL,
    ...
    [UomGL]              INT             NULL,
    [UomWD]              INT             NULL,
    [CsgFlng]            DECIMAL (19, 9) NULL,
    [RowID]              BIGINT          NOT NULL,
    [Comment]            NVARCHAR (MAX)  NULL,
    [UserDefined_12]     NVARCHAR (MAX)  NULL,
    [reportTypeId]       BIGINT          NOT NULL,
    [report_Date]        DATETIME        NOT NULL,
    CONSTRAINT [PK_WFERigElevation] PRIMARY KEY CLUSTERED ([wferigelevation_id] ASC)
);
