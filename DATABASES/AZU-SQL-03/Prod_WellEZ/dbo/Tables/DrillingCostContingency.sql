CREATE TABLE [dbo].[DrillingCostContingency] (
    [drillingcostcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]                    BIGINT          NULL,
    ...
    CONSTRAINT [PK_DrillingCostContingency] PRIMARY KEY CLUSTERED ([drillingcostcontingency_id] ASC)
);
