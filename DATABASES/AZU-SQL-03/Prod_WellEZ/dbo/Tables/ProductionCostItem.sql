CREATE TABLE [dbo].[ProductionCostItem] (
    [productioncostitem_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_ProductionCostItem] PRIMARY KEY CLUSTERED ([productioncostitem_id] ASC)
);
