CREATE TABLE [dbo].[CompletionCostItem] (
    [completioncostitem_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_CompletionCostItem] PRIMARY KEY CLUSTERED ([completioncostitem_id] ASC)
);
