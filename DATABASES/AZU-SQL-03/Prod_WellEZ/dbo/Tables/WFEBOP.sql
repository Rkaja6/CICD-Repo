CREATE TABLE [dbo].[WFEBOP] (
    [wfebop_id]         INT             IDENTITY (1, 1) NOT NULL,
    [well_id]           BIGINT          NULL,
    ...
    [Test_Date_N]       DATETIME        NULL,
    [Test_Date_L]       DATETIME        NULL,
    [reportTypeId]      BIGINT          NOT NULL,
    [RamsType]          NVARCHAR (MAX)  NULL,
    [RamsTest]          DECIMAL (19, 9) NULL,
    [RamsSz]            DECIMAL (19, 9) NULL,
    [RamsRate]          DECIMAL (19, 9) NULL,
    [RamsModel]         NVARCHAR (MAX)  NULL,
    [Drill]             DATETIME        NULL,
    [Comments]          NVARCHAR (MAX)  NULL,
    [ChokeType]         NVARCHAR (MAX)  NULL,
    [ChokeTest]         DECIMAL (19, 9) NULL,
    [ChokeSz]           DECIMAL (19, 9) NULL,
    [ChokeRate]         DECIMAL (19, 9) NULL,
    [ChokeModel]        NVARCHAR (MAX)  NULL,
    [AnnType]           NVARCHAR (MAX)  NULL,
    [AnnTest]           DECIMAL (19, 9) NULL,
    [AnnSz]             DECIMAL (19, 9) NULL,
    [AnnRate]           DECIMAL (19, 9) NULL,
    [AnnModel]          NVARCHAR (MAX)  NULL,
    [UomAnnSz]          INT             NULL,
    [UomAnnRate]        INT             NULL,
    [UomAnnTest]        INT             NULL,
    [UomRamsSz]         INT             NULL,
    [UomRamsRate]       INT             NULL,
    [UomRamsTest]       INT             NULL,
    [UomChokeSz]        INT             NULL,
    [UomChokeRate]      INT             NULL,
    [UomChokeTest]      INT             NULL,
    CONSTRAINT [PK_WFEBOP] PRIMARY KEY CLUSTERED ([wfebop_id] ASC)
);
