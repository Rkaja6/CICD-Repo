CREATE TABLE [dbo].[NonAFECostContingency] (
    [nonafecostcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]                  BIGINT          NULL,
    ...
    CONSTRAINT [PK_NonAFECostContingency] PRIMARY KEY CLUSTERED ([nonafecostcontingency_id] ASC)
);
