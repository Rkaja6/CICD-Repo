CREATE TABLE [dbo].[Weather] (
    ...
    [WindSpeed]         DECIMAL (19, 9) NULL,
    [UomWindSpeed]      INT             NULL,
    [WindDirection]     NVARCHAR (MAX)  NULL,
    [Temperature]       DECIMAL (19, 9) NULL,
    [UomTemperature]    INT             NULL,
    [SeaDirection]      NVARCHAR (MAX)  NULL,
    [reportTypeId]      BIGINT          NOT NULL,
    [Forecast]          NVARCHAR (MAX)  NULL,
    [CondSea]           NVARCHAR (MAX)  NULL,
    [CondGeneral]       NVARCHAR (MAX)  NULL,
    ...
    CONSTRAINT [PK_Weather] PRIMARY KEY CLUSTERED ([weather_id] ASC)
);
