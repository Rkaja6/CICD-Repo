CREATE TABLE [dbo].[ProductionCostContingency] (
    [productioncostcontingency_id] INT             IDENTITY (1, 1) NOT NULL,
    [well_id]                      BIGINT          NULL,
    ...
    CONSTRAINT [PK_ProductionCostContingency] PRIMARY KEY CLUSTERED ([productioncostcontingency_id] ASC)
);
