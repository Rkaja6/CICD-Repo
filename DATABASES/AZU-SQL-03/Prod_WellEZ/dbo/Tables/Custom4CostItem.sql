CREATE TABLE [dbo].[Custom4CostItem] (
    [custom4costitem_id]    INT             IDENTITY (1, 1) NOT NULL,
    [well_id]               BIGINT          NULL,
    ...
    CONSTRAINT [PK_Custom4CostItem] PRIMARY KEY CLUSTERED ([custom4costitem_id] ASC)
);
