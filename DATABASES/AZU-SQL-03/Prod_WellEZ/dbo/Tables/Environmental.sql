CREATE TABLE [dbo].[Environmental] (
    [environmental_id]  INT             IDENTITY (1, 1) NOT NULL,
    ...
    [Spills]            NVARCHAR (MAX)  NULL,
    [Sheen]             NVARCHAR (MAX)  NULL,
    [reportTypeId]      BIGINT          NOT NULL,
    [Metals]            DECIMAL (19, 9) NULL,
    [UomMetals]         INT             NULL,
    [Comment]           NVARCHAR (MAX)  NULL,
    CONSTRAINT [PK_Environmental] PRIMARY KEY CLUSTERED ([environmental_id] ASC)
);
