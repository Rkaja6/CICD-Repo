CREATE TABLE [dbo].[GEO_PRODUCING_BOSSIER_SHL] (
    ...
    CONSTRAINT [R43_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g33_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S33_idx]
    ON [dbo].[GEO_PRODUCING_BOSSIER_SHL] ([SHAPE])
    WITH  (
