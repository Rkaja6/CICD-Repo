CREATE TABLE [dbo].[RXT_OTHERRNGPLANTS] (
    [OBJECTID]          INT              NOT NULL,
    [NAME]              NVARCHAR (100)   NULL,
    [SUB_OPER]          NVARCHAR (150)   NULL,
    [OPERATOR]          NVARCHAR (150)   NULL,
    [OWNER]             NVARCHAR (200)   NULL,
    [REC_UTILITY]       NVARCHAR (150)   NULL,
    [FEEDSTOCK]         NVARCHAR (100)   NULL,
    [STATUS]            NVARCHAR (25)    NULL,
    [BIOGAS_GEN]        NUMERIC (38, 8)  NULL,
    [ELEC_GEN]          NUMERIC (38, 8)  NULL,
    [TOT_EM_RED]        NUMERIC (38, 8)  NULL,
    [USDA_FUND]         NVARCHAR (3)     NULL,
    [PIPE_INJCT]        NVARCHAR (100)   NULL,
    [ENDUSE]            NVARCHAR (200)   NULL,
    [DIGST_TYPE]        NVARCHAR (100)   NULL,
    [CO_DIGEST]         NVARCHAR (300)   NULL,
    ...
    CONSTRAINT [R754_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g717_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S717_idx]
    ON [dbo].[RXT_OTHERRNGPLANTS] ([Shape])
    WITH  (
