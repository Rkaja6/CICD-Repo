CREATE TABLE [dbo].[RXT_OTHERLIQUIDSPIPELINES] (
    ...
    CONSTRAINT [R592_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g555_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE NONCLUSTERED INDEX [I4291LOC_ID]
    ON [dbo].[RXT_OTHERLIQUIDSPIPELINES]([LOC_ID] ASC) WITH (FILLFACTOR = 75);


GO
CREATE NONCLUSTERED INDEX [I4291SYSTEM_ID]
    ON [dbo].[RXT_OTHERLIQUIDSPIPELINES]([SYSTEM_ID] ASC) WITH (FILLFACTOR = 75);


GO
CREATE SPATIAL INDEX [S555_idx]
