CREATE TABLE [dbo].[LND_TELLURIAN_LEASES_03212018] (
    ...
    [WI_Calc]           NVARCHAR (5)     NULL,
    [Shape]             [sys].[geometry] NULL,
    [GDB_GEOMATTR_DATA] VARBINARY (MAX)  NULL,
    CONSTRAINT [R55_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g45_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S45_idx]
    ON [dbo].[LND_TELLURIAN_LEASES_03212018] ([Shape])
    WITH  (
