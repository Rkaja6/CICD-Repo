CREATE TABLE [dbo].[RXT_ETHANOLBIOREFINERIES] (
    ...
    CONSTRAINT [R746_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g709_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S709_idx]
    ON [dbo].[RXT_ETHANOLBIOREFINERIES] ([Shape])
    WITH  (
