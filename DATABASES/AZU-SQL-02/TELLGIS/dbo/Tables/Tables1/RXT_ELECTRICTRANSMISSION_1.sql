CREATE TABLE [dbo].[RXT_ELECTRICTRANSMISSION_1] (
    ...
    CONSTRAINT [R744_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g707_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S707_idx]
    ON [dbo].[RXT_ELECTRICTRANSMISSION_1] ([Shape])
    WITH  (
