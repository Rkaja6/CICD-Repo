CREATE TABLE [dbo].[DFW_COUNTRIES_SOUTH_AMERICA] (
    ...
    CONSTRAINT [R710_pk] PRIMARY KEY CLUSTERED ([OBJECTID_1] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g673_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S673_idx]
    ON [dbo].[DFW_COUNTRIES_SOUTH_AMERICA] ([Shape])
    WITH  (
