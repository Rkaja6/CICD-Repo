CREATE TABLE [dbo].[RXT_PRODUCTSPUMPSTATIONS] (
    ...
    CONSTRAINT [R515_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g478_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S478_idx]
    ON [dbo].[RXT_PRODUCTSPUMPSTATIONS] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -8394810.9695, XMIN = -13709663.7301, YMAX = 5919679.4952, YMIN = 3370369.8708)
          );
