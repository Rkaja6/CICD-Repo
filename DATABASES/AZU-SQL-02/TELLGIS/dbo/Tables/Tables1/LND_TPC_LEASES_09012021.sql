CREATE TABLE [dbo].[LND_TPC_LEASES_09012021] (
    ...
    CONSTRAINT [R553_pk] PRIMARY KEY CLUSTERED ([OBJECTID_1] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g516_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S516_idx]
    ON [dbo].[LND_TPC_LEASES_09012021] ([Shape])
    WITH  (
