CREATE TABLE [dbo].[RXT_OILSEEDPLANTS] (
    ...
    CONSTRAINT [R753_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g716_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S716_idx]
    ON [dbo].[RXT_OILSEEDPLANTS] ([Shape])
    WITH  (
