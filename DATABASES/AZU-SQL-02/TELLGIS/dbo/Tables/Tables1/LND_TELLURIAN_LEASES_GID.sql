CREATE TABLE [dbo].[LND_TELLURIAN_LEASES_GID] (
    ...
    CONSTRAINT [R61_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g51_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S51_idx]
    ON [dbo].[LND_TELLURIAN_LEASES_GID] ([Shape])
    WITH  (
