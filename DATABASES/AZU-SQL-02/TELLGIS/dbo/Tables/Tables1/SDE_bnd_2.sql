CREATE TABLE [dbo].[SDE_bnd_2] (
    ...
    [cdate]          INT           NOT NULL,
    [mdate]          INT           NOT NULL,
    CONSTRAINT [SDE_bnd_2_pk] PRIMARY KEY NONCLUSTERED ([rasterband_id] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [SDE_bnd_2_uk2] UNIQUE NONCLUSTERED ([raster_id] ASC, [sequence_nbr] ASC) WITH (FILLFACTOR = 75)
);
