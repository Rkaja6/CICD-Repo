CREATE TABLE [dbo].[LND_TPC_LEASES_09012021_V2] (
    ...
    CONSTRAINT [R557_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g520_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S520_idx]
    ON [dbo].[LND_TPC_LEASES_09012021_V2] ([Shape])
    WITH  (
