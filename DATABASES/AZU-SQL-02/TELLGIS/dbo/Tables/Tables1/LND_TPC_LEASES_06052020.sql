CREATE TABLE [dbo].[LND_TPC_LEASES_06052020] (
    ...
    CONSTRAINT [R482_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g445_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S445_idx]
    ON [dbo].[LND_TPC_LEASES_06052020] ([Shape])
    WITH  (
