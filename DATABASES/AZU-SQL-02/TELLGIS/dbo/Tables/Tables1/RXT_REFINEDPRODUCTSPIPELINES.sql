CREATE TABLE [dbo].[RXT_REFINEDPRODUCTSPIPELINES] (
    ...
    CONSTRAINT [R594_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g557_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE NONCLUSTERED INDEX [I4293LOC_ID]
    ON [dbo].[RXT_REFINEDPRODUCTSPIPELINES]([LOC_ID] ASC) WITH (FILLFACTOR = 75);


GO
CREATE NONCLUSTERED INDEX [I4293SYSTEM_ID]
    ON [dbo].[RXT_REFINEDPRODUCTSPIPELINES]([SYSTEM_ID] ASC) WITH (FILLFACTOR = 75);


GO
CREATE SPATIAL INDEX [S557_idx]
