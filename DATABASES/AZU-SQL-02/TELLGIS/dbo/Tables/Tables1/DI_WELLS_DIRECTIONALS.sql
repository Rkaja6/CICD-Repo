CREATE TABLE [dbo].[DI_WELLS_DIRECTIONALS] (
    ...
    CONSTRAINT [R529_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g492_ck] CHECK ([SHAPE].[STSrid]=(3857))
);
...
GO
CREATE NONCLUSTERED INDEX [I1539wellId]
    ON [dbo].[DI_WELLS_DIRECTIONALS]([wellId] ASC) WITH (FILLFACTOR = 75);


GO
CREATE SPATIAL INDEX [S492_idx]
