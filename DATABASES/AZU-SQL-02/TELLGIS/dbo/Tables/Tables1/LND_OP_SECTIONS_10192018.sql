CREATE TABLE [dbo].[LND_OP_SECTIONS_10192018] (
    ...
    CONSTRAINT [R449_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g412_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S412_idx]
    ON [dbo].[LND_OP_SECTIONS_10192018] ([Shape])
    WITH  (
