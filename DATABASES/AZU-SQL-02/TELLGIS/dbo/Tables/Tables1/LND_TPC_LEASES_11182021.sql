CREATE TABLE [dbo].[LND_TPC_LEASES_11182021] (
    ...
    CONSTRAINT [R578_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g541_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S541_idx]
    ON [dbo].[LND_TPC_LEASES_11182021] ([Shape])
    WITH  (
