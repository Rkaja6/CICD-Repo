CREATE TABLE [dbo].[LND_TELL_NONOP_SECS] (
    ...
    CONSTRAINT [R782_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g745_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S745_idx]
    ON [dbo].[LND_TELL_NONOP_SECS] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10373395.5457815, XMIN = -10468796.587361, YMAX = 3815289.90473433, YMIN = 3723955.48222798)
          );
