CREATE TABLE [dbo].[LND_TELLURIAN_LEASES_07182018] (
    ...
    [CoNet]             NUMERIC (38, 8)  NULL,
    [Legal_Desc]        NVARCHAR (500)   NULL,
    [Shape]             [sys].[geometry] NULL,
    [GDB_GEOMATTR_DATA] VARBINARY (MAX)  NULL,
    CONSTRAINT [R56_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g46_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S46_idx]
    ON [dbo].[LND_TELLURIAN_LEASES_07182018] ([Shape])
    WITH  (
