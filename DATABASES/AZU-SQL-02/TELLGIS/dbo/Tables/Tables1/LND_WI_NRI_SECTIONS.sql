CREATE TABLE [dbo].[LND_WI_NRI_SECTIONS] (
    ...
    CONSTRAINT [R460_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g423_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S423_idx]
    ON [dbo].[LND_WI_NRI_SECTIONS] ([Shape])
    WITH  (
