CREATE TABLE [dbo].[LND_TELLURIAN_LEASES_07182018_V2] (
    ...
    CONSTRAINT [R57_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g47_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S47_idx]
    ON [dbo].[LND_TELLURIAN_LEASES_07182018_V2] ([Shape])
    WITH  (
