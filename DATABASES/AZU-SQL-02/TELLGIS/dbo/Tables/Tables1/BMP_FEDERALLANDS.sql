CREATE TABLE [dbo].[BMP_FEDERALLANDS] (
    ...
    CONSTRAINT [R80_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g70_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S70_idx]
    ON [dbo].[BMP_FEDERALLANDS] ([SHAPE])
    WITH  (
