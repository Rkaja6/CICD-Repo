CREATE TABLE [dbo].[GEO_SWD_DRILLINGINFO_TX_BUFF] (
    ...
    CONSTRAINT [R439_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g402_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S402_idx]
    ON [dbo].[GEO_SWD_DRILLINGINFO_TX_BUFF] ([Shape])
    WITH  (
