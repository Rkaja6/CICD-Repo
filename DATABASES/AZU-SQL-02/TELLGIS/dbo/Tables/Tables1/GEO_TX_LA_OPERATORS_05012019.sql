CREATE TABLE [dbo].[GEO_TX_LA_OPERATORS_05012019] (
    ...
    CONSTRAINT [R421_pk] PRIMARY KEY CLUSTERED ([OBJECTID_1] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g384_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S384_idx]
    ON [dbo].[GEO_TX_LA_OPERATORS_05012019] ([Shape])
    WITH  (
