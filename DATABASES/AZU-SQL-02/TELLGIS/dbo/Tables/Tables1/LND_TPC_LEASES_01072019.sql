CREATE TABLE [dbo].[LND_TPC_LEASES_01072019] (
    ...
    CONSTRAINT [R425_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g388_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S388_idx]
    ON [dbo].[LND_TPC_LEASES_01072019] ([Shape])
    WITH  (
