CREATE TABLE [dbo].[LND_TELL_ORRI_SECX] (
    ...
    CONSTRAINT [R659_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g622_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S622_idx]
    ON [dbo].[LND_TELL_ORRI_SECX] ([Shape])
    WITH  (
