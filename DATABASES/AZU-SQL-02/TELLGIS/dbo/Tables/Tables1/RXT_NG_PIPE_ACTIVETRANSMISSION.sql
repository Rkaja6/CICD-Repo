CREATE TABLE [dbo].[RXT_NG_PIPE_ACTIVETRANSMISSION] (
    ...
    CONSTRAINT [R162_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g143_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S143_idx]
    ON [dbo].[RXT_NG_PIPE_ACTIVETRANSMISSION] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -5957777.226, XMIN = -16881913.8232, YMAX = 11230214.758, YMIN = 1670312.6264),
            CELLS_PER_OBJECT = 16
          );
