CREATE TABLE [dbo].[SDE_bnd_3] (
    ...
    [cdate]          INT           NOT NULL,
    [mdate]          INT           NOT NULL,
    CONSTRAINT [SDE_bnd_3_pk] PRIMARY KEY NONCLUSTERED ([rasterband_id] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [SDE_bnd_3_uk2] UNIQUE NONCLUSTERED ([raster_id] ASC, [sequence_nbr] ASC) WITH (FILLFACTOR = 75)
);
