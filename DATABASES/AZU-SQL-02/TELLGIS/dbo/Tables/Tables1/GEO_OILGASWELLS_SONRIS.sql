CREATE TABLE [dbo].[GEO_OILGASWELLS_SONRIS] (
    ...
    CONSTRAINT [g192_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S192_idx]
    ON [dbo].[GEO_OILGASWELLS_SONRIS] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -6830498.29689003, XMIN = -10774320.1048864, YMAX = 5740971.82981944, YMIN = 3357719.09214562),
            CELLS_PER_OBJECT = 16
          );
