CREATE TABLE [dbo].[LND_TPC_LEASESX] (
    ...
    CONSTRAINT [R596_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g559_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S559_idx]
    ON [dbo].[LND_TPC_LEASESX] ([Shape])
    WITH  (
