CREATE TABLE [dbo].[LND_ENSIGHT_LEASES] (
    ...
    [YR_EXP]            NVARCHAR (5)     NULL,
    [Notes]             NVARCHAR (25)    NULL,
    [Shape]             [sys].[geometry] NULL,
    [GDB_GEOMATTR_DATA] VARBINARY (MAX)  NULL,
    CONSTRAINT [R762_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g725_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S725_idx]
    ON [dbo].[LND_ENSIGHT_LEASES] ([Shape])
    WITH  (
