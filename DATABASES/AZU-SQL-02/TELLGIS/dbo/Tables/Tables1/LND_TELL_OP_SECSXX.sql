CREATE TABLE [dbo].[LND_TELL_OP_SECSXX] (
    ...
    CONSTRAINT [R702_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g665_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S665_idx]
    ON [dbo].[LND_TELL_OP_SECSXX] ([Shape])
    WITH  (
