CREATE TABLE [dbo].[LND_SECTIONS_ORRI] (
    ...
    CONSTRAINT [R304_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g285_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S285_idx]
    ON [dbo].[LND_SECTIONS_ORRI] ([Shape])
    WITH  (
