CREATE TABLE [dbo].[LND_TELL_NONOP_SECSX] (
    ...
    CONSTRAINT [R658_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g621_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S621_idx]
    ON [dbo].[LND_TELL_NONOP_SECSX] ([Shape])
    WITH  (
