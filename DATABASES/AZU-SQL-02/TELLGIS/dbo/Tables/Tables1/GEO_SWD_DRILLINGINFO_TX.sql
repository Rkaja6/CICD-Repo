CREATE TABLE [dbo].[GEO_SWD_DRILLINGINFO_TX] (
    ...
    CONSTRAINT [R438_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g401_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S401_idx]
    ON [dbo].[GEO_SWD_DRILLINGINFO_TX] ([Shape])
    WITH  (
