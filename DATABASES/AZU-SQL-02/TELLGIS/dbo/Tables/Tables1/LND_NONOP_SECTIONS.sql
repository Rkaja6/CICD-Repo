CREATE TABLE [dbo].[LND_NONOP_SECTIONS] (
    ...
    CONSTRAINT [R451_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g414_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S414_idx]
    ON [dbo].[LND_NONOP_SECTIONS] ([Shape])
    WITH  (
