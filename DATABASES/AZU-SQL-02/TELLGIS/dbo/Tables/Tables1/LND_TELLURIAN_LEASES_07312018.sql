CREATE TABLE [dbo].[LND_TELLURIAN_LEASES_07312018] (
    ...
    CONSTRAINT [R59_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g49_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S49_idx]
    ON [dbo].[LND_TELLURIAN_LEASES_07312018] ([Shape])
    WITH  (
