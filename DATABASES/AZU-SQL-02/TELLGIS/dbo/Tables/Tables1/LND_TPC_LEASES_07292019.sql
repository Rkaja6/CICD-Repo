CREATE TABLE [dbo].[LND_TPC_LEASES_07292019] (
    ...
    CONSTRAINT [R446_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g409_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S409_idx]
    ON [dbo].[LND_TPC_LEASES_07292019] ([Shape])
    WITH  (
