CREATE TABLE [dbo].[GEO_SWD_DRILLINGINFO_TX_BUFF_03282019] (
    ...
    CONSTRAINT [R410_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g373_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S373_idx]
    ON [dbo].[GEO_SWD_DRILLINGINFO_TX_BUFF_03282019] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10461325.355281, XMIN = -10711610.3124477, YMAX = 3878253.40402144, YMIN = 3693821.71178405),
            CELLS_PER_OBJECT = 16
          );
