CREATE TABLE [dbo].[LND_ORRI_SECTIONS] (
    ...
    CONSTRAINT [R453_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g416_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S416_idx]
    ON [dbo].[LND_ORRI_SECTIONS] ([Shape])
    WITH  (
