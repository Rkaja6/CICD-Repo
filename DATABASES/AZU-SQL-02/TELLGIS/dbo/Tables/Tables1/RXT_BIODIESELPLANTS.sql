CREATE TABLE [dbo].[RXT_BIODIESELPLANTS] (
    ...
    CONSTRAINT [R740_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g703_ck] CHECK ([Shape].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S703_idx]
    ON [dbo].[RXT_BIODIESELPLANTS] ([Shape])
    WITH  (
