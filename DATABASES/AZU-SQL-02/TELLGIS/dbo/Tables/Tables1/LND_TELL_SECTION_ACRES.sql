CREATE TABLE [dbo].[LND_TELL_SECTION_ACRES] (
    ...
    CONSTRAINT [R607_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g570_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S570_idx]
    ON [dbo].[LND_TELL_SECTION_ACRES] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10373395.5458, XMIN = -10468796.5874, YMAX = 3788557.1216, YMIN = 3723955.4822),
            CELLS_PER_OBJECT = 16
          );
