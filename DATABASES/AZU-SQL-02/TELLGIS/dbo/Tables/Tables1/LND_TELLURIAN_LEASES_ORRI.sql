CREATE TABLE [dbo].[LND_TELLURIAN_LEASES_ORRI] (
    ...
    CONSTRAINT [R226_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
...
CREATE SPATIAL INDEX [S207_idx]
    ON [dbo].[LND_TELLURIAN_LEASES_ORRI] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10382926.6748, XMIN = -10405446.6564, YMAX = 3787339.9334, YMIN = 3752548.547),
            CELLS_PER_OBJECT = 16
          );
