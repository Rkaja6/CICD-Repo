CREATE TABLE [dbo].[LND_TPC_LEASES] (
    ...
    CONSTRAINT [R701_pk] PRIMARY KEY CLUSTERED ([OBJECTID_1] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g664_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S664_idx]
    ON [dbo].[LND_TPC_LEASES] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10369569.0247, XMIN = -10468454.8058, YMAX = 3787587.97670001, YMIN = 3724169.46890001)
          );
