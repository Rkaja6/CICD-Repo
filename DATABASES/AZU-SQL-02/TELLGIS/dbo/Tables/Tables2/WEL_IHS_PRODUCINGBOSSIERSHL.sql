CREATE TABLE [dbo].[WEL_IHS_PRODUCINGBOSSIERSHL] (
    ...
    CONSTRAINT [R576_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g539_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S539_idx]
    ON [dbo].[WEL_IHS_PRODUCINGBOSSIERSHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10265210.3464301, XMIN = -10749668.2663758, YMAX = 3881075.48342875, YMIN = 3528788.29941328),
            CELLS_PER_OBJECT = 16
          );
