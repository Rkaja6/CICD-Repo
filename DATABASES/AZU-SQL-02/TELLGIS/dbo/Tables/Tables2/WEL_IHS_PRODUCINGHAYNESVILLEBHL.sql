CREATE TABLE [dbo].[WEL_IHS_PRODUCINGHAYNESVILLEBHL] (
    ...
    CONSTRAINT [R574_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g537_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S537_idx]
    ON [dbo].[WEL_IHS_PRODUCINGHAYNESVILLEBHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10059877.9913419, XMIN = -10733258.0719145, YMAX = 3895531.11550083, YMIN = 3401095.29144019),
            CELLS_PER_OBJECT = 16
          );
