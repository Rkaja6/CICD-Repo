CREATE TABLE [dbo].[UPS_60DEV_PLANNED_BSSR_BORE] (
    ...
    CONSTRAINT [R643_pk] PRIMARY KEY CLUSTERED ([OBJECTID_12] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g606_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S606_idx]
    ON [dbo].[UPS_60DEV_PLANNED_BSSR_BORE] ([Shape])
    WITH  (
