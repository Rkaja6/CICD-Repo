CREATE TABLE [dbo].[WEL_SONRIS_INJWELLS_07102019] (
    ...
    CONSTRAINT [R412_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g375_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S375_idx]
    ON [dbo].[WEL_SONRIS_INJWELLS_07102019] ([Shape])
    WITH  (
