CREATE TABLE [dbo].[WEL_IHS_PRODUCINGBOSSIERBHL] (
    ...
    CONSTRAINT [R577_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g540_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S540_idx]
    ON [dbo].[WEL_IHS_PRODUCINGBOSSIERBHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10310303.8212001, XMIN = -10748860.2314767, YMAX = 3871484.53151866, YMIN = 3604496.43072673),
            CELLS_PER_OBJECT = 16
          );
