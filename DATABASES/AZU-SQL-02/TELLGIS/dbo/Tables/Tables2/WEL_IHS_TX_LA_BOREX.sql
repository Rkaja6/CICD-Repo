CREATE TABLE [dbo].[WEL_IHS_TX_LA_BOREX] (
    ...
    CONSTRAINT [R699_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g662_ck] CHECK ([Shape].[STSrid]=(26781))
);


GO
CREATE SPATIAL INDEX [S662_idx]
    ON [dbo].[WEL_IHS_TX_LA_BOREX] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = 128290500, XMIN = -124290500, YMAX = 45451600, YMIN = -92210800)
          );
