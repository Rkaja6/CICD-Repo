CREATE TABLE [dbo].[WEL_TELLWELLS_BORE] (
    ...
    [ShapeLine_STLength__]            NUMERIC (38, 8)  NOT NULL,
    [Shape]                           [sys].[geometry] NULL,
    [GDB_GEOMATTR_DATA]               VARBINARY (MAX)  NULL,
    CONSTRAINT [R600_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g563_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S563_idx]
    ON [dbo].[WEL_TELLWELLS_BORE] ([Shape])
    WITH  (
