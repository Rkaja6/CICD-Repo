CREATE TABLE [dbo].[WEL_ROYALTY_BORE] (
    ...
    CONSTRAINT [R435_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g398_ck] CHECK ([SHAPELINE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S398_idx]
    ON [dbo].[WEL_ROYALTY_BORE] ([ShapeLine])
    WITH  (
            BOUNDING_BOX = (XMAX = -10384681.4925604, XMIN = -10422318.0056296, YMAX = 3788419.60932366, YMIN = 3737411.61406879),
            CELLS_PER_OBJECT = 16
          );
