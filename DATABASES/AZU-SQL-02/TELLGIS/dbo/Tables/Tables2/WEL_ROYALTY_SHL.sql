CREATE TABLE [dbo].[WEL_ROYALTY_SHL] (
    ...
    CONSTRAINT [R433_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g396_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S396_idx]
    ON [dbo].[WEL_ROYALTY_SHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10384711.3708944, XMIN = -10422274.9182358, YMAX = 3786932.7351805, YMIN = 3739113.08756514),
            CELLS_PER_OBJECT = 16
          );
