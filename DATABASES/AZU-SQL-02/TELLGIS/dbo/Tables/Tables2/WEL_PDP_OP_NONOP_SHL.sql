CREATE TABLE [dbo].[WEL_PDP_OP_NONOP_SHL] (
    ...
    CONSTRAINT [R430_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g393_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S393_idx]
    ON [dbo].[WEL_PDP_OP_NONOP_SHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10376589.8543018, XMIN = -10466388.8960002, YMAX = 3788651.46209621, YMIN = 3727002.51188209),
            CELLS_PER_OBJECT = 16
          );
