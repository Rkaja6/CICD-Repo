CREATE TABLE [dbo].[WEL_IHS_PRODUCINGHAYNESVILLESHL] (
    ...
    CONSTRAINT [R573_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g536_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S536_idx]
    ON [dbo].[WEL_IHS_PRODUCINGHAYNESVILLESHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10059146.3441, XMIN = -10733151.6189779, YMAX = 3897708.4120421, YMIN = 3400413.97215728),
            CELLS_PER_OBJECT = 16
          );
