CREATE TABLE [dbo].[WEL_IHS_TX_LA_BHL] (
    ...
    CONSTRAINT [R772_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g735_ck] CHECK ([SHAPE].[STSrid]=(4326))
);


GO
CREATE SPATIAL INDEX [S735_idx]
    ON [dbo].[WEL_IHS_TX_LA_BHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -87.765395701, XMIN = -105.812064338, YMAX = 36.499546485, YMIN = 25.88153778)
          );
