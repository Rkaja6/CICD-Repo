CREATE TABLE [dbo].[WEL_ENV_HSVL_LN] (
    [OBJECTID]          INT              NOT NULL,
    [LAYER]             NVARCHAR (17)    NULL,
    [MAP_NAME]          NVARCHAR (47)    NULL,
    ...
    [geomWKT]           NVARCHAR (254)   NULL,
    [LINE_STYLE]        NVARCHAR (5)     NULL,
    [LINE_COLOR]        NVARCHAR (10)    NULL,
    [LINE_WIDTH]        SMALLINT         NULL,
    [Maplabel]          NVARCHAR (50)    NULL,
    [Shape]             [sys].[geometry] NULL,
    [GDB_GEOMATTR_DATA] VARBINARY (MAX)  NULL,
    CONSTRAINT [R689_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g652_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S652_idx]
    ON [dbo].[WEL_ENV_HSVL_LN] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10362138.6216574, XMIN = -10540537.1568896, YMAX = 3863549.60625415, YMIN = 3669960.4911486)
          );
