CREATE TABLE [dbo].[WEL_IHS_TX_LA_SHL] (
    ...
    CONSTRAINT [R773_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g736_ck] CHECK ([SHAPE].[STSrid]=(4326))
);


GO
CREATE SPATIAL INDEX [S736_idx]
    ON [dbo].[WEL_IHS_TX_LA_SHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -87.765395701, XMIN = -106.597545866, YMAX = 36.499042739, YMIN = 25.856561361)
          );
