CREATE TABLE [dbo].[UPS_60DEV_PLANNED_HSVL_BORE] (
    ...
    CONSTRAINT [R642_pk] PRIMARY KEY CLUSTERED ([OBJECTID_1] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g605_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S605_idx]
    ON [dbo].[UPS_60DEV_PLANNED_HSVL_BORE] ([Shape])
    WITH  (
