CREATE TABLE [dbo].[WEL_ROYALTY_BHL] (
    ...
    CONSTRAINT [R434_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g397_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S397_idx]
    ON [dbo].[WEL_ROYALTY_BHL] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10384681.5021305, XMIN = -10422317.9589988, YMAX = 3788425.40991919, YMIN = 3737404.85166548),
            CELLS_PER_OBJECT = 16
          );
