CREATE TABLE [dbo].[WEL_TELLWELLS_SHL] (
    ...
    CONSTRAINT [R532_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g495_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S495_idx]
    ON [dbo].[WEL_TELLWELLS_SHL] ([Shape])
    WITH  (
