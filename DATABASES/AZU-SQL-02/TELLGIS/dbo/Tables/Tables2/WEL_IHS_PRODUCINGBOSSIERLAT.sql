CREATE TABLE [dbo].[WEL_IHS_PRODUCINGBOSSIERLAT] (
    ...
    CONSTRAINT [R575_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g538_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S538_idx]
    ON [dbo].[WEL_IHS_PRODUCINGBOSSIERLAT] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10310303.8242058, XMIN = -10748975.6456323, YMAX = 3871994.3937821, YMIN = 3604417.17339964),
            CELLS_PER_OBJECT = 16
          );
