CREATE TABLE [dbo].[UPS_Q42022_HSVL_DEVWELLS_RBORE] (
    ...
    CONSTRAINT [R776_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g739_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S739_idx]
    ON [dbo].[UPS_Q42022_HSVL_DEVWELLS_RBORE] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10375510.2098217, XMIN = -10468674.008562, YMAX = 3786538.96948314, YMIN = 3724037.65856829)
          );
