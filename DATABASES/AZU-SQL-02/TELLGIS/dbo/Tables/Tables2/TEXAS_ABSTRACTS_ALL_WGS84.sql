CREATE TABLE [dbo].[TEXAS_ABSTRACTS_ALL_WGS84] (
    ...
    CONSTRAINT [R66_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g56_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S56_idx]
    ON [dbo].[TEXAS_ABSTRACTS_ALL_WGS84] ([SHAPE])
    WITH  (
