CREATE TABLE [dbo].[WEL_IHS_TX_LA_BORE] (
    ...
    CONSTRAINT [R774_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g737_ck] CHECK ([SHAPE].[STSrid]=(4326))
);


GO
CREATE SPATIAL INDEX [S737_idx]
    ON [dbo].[WEL_IHS_TX_LA_BORE] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -90.711112211, XMIN = -94.042767421, YMAX = 33.019214139, YMIN = 29.623301326)
          );
