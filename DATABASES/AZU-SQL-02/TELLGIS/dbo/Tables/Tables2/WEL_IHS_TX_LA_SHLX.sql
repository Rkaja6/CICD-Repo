CREATE TABLE [dbo].[WEL_IHS_TX_LA_SHLX] (
    ...
    CONSTRAINT [R700_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g663_ck] CHECK ([Shape].[STSrid]=(26781))
);


GO
CREATE SPATIAL INDEX [S663_idx]
    ON [dbo].[WEL_IHS_TX_LA_SHLX] ([Shape])
    WITH  (
