CREATE TABLE [dbo].[WEL_TELLWELLS_BHL] (
    ...
    CONSTRAINT [R531_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g494_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S494_idx]
    ON [dbo].[WEL_TELLWELLS_BHL] ([Shape])
    WITH  (
