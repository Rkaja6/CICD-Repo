CREATE TABLE [dbo].[UPS_Q32022_BSSR_DEVWELLS_RBORE] (
    ...
    CONSTRAINT [R692_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g655_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S655_idx]
    ON [dbo].[UPS_Q32022_BSSR_DEVWELLS_RBORE] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10373626.6614998, XMIN = -10435661.7611513, YMAX = 3788436.42732864, YMIN = 3724075.23201893)
          );
