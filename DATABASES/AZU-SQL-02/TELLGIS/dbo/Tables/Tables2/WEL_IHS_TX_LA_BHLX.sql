CREATE TABLE [dbo].[WEL_IHS_TX_LA_BHLX] (
    ...
    CONSTRAINT [R698_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g661_ck] CHECK ([Shape].[STSrid]=(26781))
);


GO
CREATE SPATIAL INDEX [S661_idx]
    ON [dbo].[WEL_IHS_TX_LA_BHLX] ([Shape])
    WITH  (
