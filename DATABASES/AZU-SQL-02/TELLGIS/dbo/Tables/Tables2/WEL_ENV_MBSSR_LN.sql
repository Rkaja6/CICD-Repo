CREATE TABLE [dbo].[WEL_ENV_MBSSR_LN] (
    ...
    CONSTRAINT [R690_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g653_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S653_idx]
    ON [dbo].[WEL_ENV_MBSSR_LN] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -10372677.7269347, XMIN = -10533471.0290298, YMAX = 3792241.73398896, YMIN = 3669975.00875685)
          );
