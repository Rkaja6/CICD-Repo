CREATE TABLE [dbo].[WEL_PDP_OP_NONOP_BORE] (
    ...
    [ShapeLine]                       [sys].[geometry] NULL,
    [GDB_GEOMATTR_DATA]               VARBINARY (MAX)  NULL,
    CONSTRAINT [R432_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g395_ck] CHECK ([SHAPELINE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S395_idx]
    ON [dbo].[WEL_PDP_OP_NONOP_BORE] ([ShapeLine])
    WITH  (
            BOUNDING_BOX = (XMAX = -10376589.8543018, XMIN = -10466474.2034463, YMAX = 3788925.5135667, YMIN = 3724248.568889),
            CELLS_PER_OBJECT = 16
          );
