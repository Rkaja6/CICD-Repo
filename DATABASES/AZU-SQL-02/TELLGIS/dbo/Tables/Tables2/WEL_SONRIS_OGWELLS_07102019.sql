CREATE TABLE [dbo].[WEL_SONRIS_OGWELLS_07102019] (
    ...
    CONSTRAINT [R411_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g374_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S374_idx]
    ON [dbo].[WEL_SONRIS_OGWELLS_07102019] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -9677897.64475075, XMIN = -10965136.4051504, YMAX = 6378634.66102444, YMIN = 3357719.09217714),
            CELLS_PER_OBJECT = 16
          );
