...
/******************************
** Name:  sp_Generate_UV_AC_Production_Aggregations_v2_byAPI
...
*******************************/
CREATE PROCEDURE [DW].[sp_Generate_UV_AC_Production_Aggregations_v2_byAPI]
...
DELETE A
FROM [Upstream].[UV_AC_PRODUCT_AT] A
INNER JOIN [StageIHS].[API_Update_List] api
on A.API = api.API14;
