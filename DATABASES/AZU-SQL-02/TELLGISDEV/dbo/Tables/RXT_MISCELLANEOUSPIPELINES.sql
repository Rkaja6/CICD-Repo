CREATE TABLE [dbo].[RXT_MISCELLANEOUSPIPELINES] (
    ...
    CONSTRAINT [R239_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
    CONSTRAINT [g211_ck] CHECK ([SHAPE].[STSrid]=(3857))
);


GO
CREATE NONCLUSTERED INDEX [I630SYSTEM_ID]
    ON [dbo].[RXT_MISCELLANEOUSPIPELINES]([SYSTEM_ID] ASC) WITH (FILLFACTOR = 75);


GO
CREATE NONCLUSTERED INDEX [I630LOC_ID]
    ON [dbo].[RXT_MISCELLANEOUSPIPELINES]([LOC_ID] ASC) WITH (FILLFACTOR = 75);


GO
CREATE SPATIAL INDEX [S211_idx]
