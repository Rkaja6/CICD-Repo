CREATE TABLE [dbo].[WEL_IHS_TX_LA_BORE] (
    ...
    CONSTRAINT [g127_ck] CHECK ([SHAPELINE].[STSrid]=(3857))
);


GO
CREATE SPATIAL INDEX [S127_idx]
    ON [dbo].[WEL_IHS_TX_LA_BORE] ([ShapeLine])
    WITH  (
            BOUNDING_BOX = (XMAX = -9770120.3796, XMIN = -11778237.8844, YMAX = 4369569.3578, YMIN = 2984380.6447),
            CELLS_PER_OBJECT = 16
          );
