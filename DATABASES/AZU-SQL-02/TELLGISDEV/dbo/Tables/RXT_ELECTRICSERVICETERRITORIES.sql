CREATE TABLE [dbo].[RXT_ELECTRICSERVICETERRITORIES] (
    ...
    CONSTRAINT [R232_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
...
CREATE SPATIAL INDEX [S204_idx]
    ON [dbo].[RXT_ELECTRICSERVICETERRITORIES] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -7452820.5898, XMIN = -17618728.1305, YMAX = 9675387.4287, YMIN = 2144989.5236)
          );
