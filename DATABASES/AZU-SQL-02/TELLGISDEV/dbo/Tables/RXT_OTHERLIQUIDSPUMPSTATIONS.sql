CREATE TABLE [dbo].[RXT_OTHERLIQUIDSPUMPSTATIONS] (
    ...
    CONSTRAINT [R211_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
...
CREATE SPATIAL INDEX [S183_idx]
    ON [dbo].[RXT_OTHERLIQUIDSPUMPSTATIONS] ([Shape])
    WITH  (
            BOUNDING_BOX = (XMAX = -8306728.8536, XMIN = -12628026.0753, YMAX = 7114027.7096, YMIN = 3185605.9698)
          );
