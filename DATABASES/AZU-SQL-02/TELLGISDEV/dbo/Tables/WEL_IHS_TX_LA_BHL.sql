CREATE TABLE [dbo].[WEL_IHS_TX_LA_BHL] (
    ...
    CONSTRAINT [R154_pk] PRIMARY KEY CLUSTERED ([OBJECTID] ASC) WITH (FILLFACTOR = 75),
...
CREATE SPATIAL INDEX [S126_idx]
    ...
    WITH  (
            BOUNDING_BOX = (XMAX = -9770120.3796, XMIN = -11778198.566, YMAX = 4369410.0762, YMIN = 2984416.2727),
            CELLS_PER_OBJECT = 16
          );
