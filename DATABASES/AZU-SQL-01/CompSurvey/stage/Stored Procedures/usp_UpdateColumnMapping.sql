...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('BaseAnnual_NumObs','HourlyRate_NumObs'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('BaseAnnual_NumOrgs','HourlyRate_NumOrgs'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('BaseAnnual_Perc25_IW','BaseAnnual_Perc25_OW','HourlyRate_Perc25_IW','HourlyRate_Perc25_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('BaseAnnual_Median_IW','BaseAnnual_Median_OW','HourlyRate_Median_IW','HourlyRate_Median_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('BaseAnnual_Perc75_IW','BaseAnnual_Perc75_OW','HourlyRate_Perc75_IW','HourlyRate_Perc75_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('BaseAnnual_Perc90_IW','BaseAnnual_Perc90_OW','HourlyRate_Perc90_IW','HourlyRate_Perc90_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('TotalCashCompensationActuallessAllowancesMTCS_Perc25_IW','TotalCashCompensationActuallessAllowancesMTCS_Perc25_OW','TotalCashActual_Perc25_IW','TotalCashActual_Perc25_OW','TotalCashCompensationActuallessAllowances_Perc25_IW','TotalCashCompensationActuallessAllowances_Perc25_OW','TotalCashCompensationActuallessAllowancesHourlyMTCS_Perc25_IW','TotalCashCompensationActuallessAllowancesHourlyMTCS_Perc25_OW '))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('TotalCashCompensationTargetlessAllowancesMTCS_Perc90_IW','TotalCashCompensationTargetlessAllowancesMTCS_Perc90_OW','TotalCashTarget_Perc90_IW','TotalCashTarget_Perc90_OW','TotalCashCompensationTargetlessAllowances_Perc90_IW','TotalCashCompensationTargetlessAllowances_Perc90_OW','TotalCashCompensationTargetlessAllowancesHourlyMTCS_Perc90_IW','TotalCashCompensationTargetlessAllowancesHourlyMTCS_Perc90_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('LtiAmount_Perc25_IW','LtiAmount_Perc25_OW','LTIBlackScholesHourly_Perc25_IW','LTIBlackScholesHourly_Perc25_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('LtiAmount_Median_IW','LtiAmount_Median_OW','LTIBlackScholesHourly_Median_IW','LTIBlackScholesHourly_Median_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('LtiAmount_Perc75_IW','LtiAmount_Perc75_OW','LTIBlackScholesHourly_Perc75_IW','LTIBlackScholesHourly_Perc75_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('LtiAmount_Perc90_IW','LtiAmount_Perc90_OW','LTIBlackScholesHourly_Perc90_IW','LTIBlackScholesHourly_Perc90_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('TotalDirectCompensationTargetlessAllowancesBlackScholesMTCS_Perc25_IW','TotalDirectCompensationTargetlessAllowancesBlackScholesMTCS_Perc25_OW','TotalDirectTarget_Perc25_IW','TotalDirectTarget_Perc25_OW','TotalDirectCompensationTargetlessAllowancesBlackScholes_Perc25_IW','TotalDirectCompensationTargetlessAllowancesBlackScholes_Perc25_OW','TotalDirectCompensationTargetlessAllowancesBlackScholesHourlyMTCS_Perc25_IW','TotalDirectCompensationTargetlessAllowancesBlackScholesHourlyMTCS_Perc25_OW'))
...
WHERE 
	(src.PublisherCode = 'ME' AND hdr.value in ('TotalDirectCompensationTargetlessAllowancesBlackScholesMTCS_Perc75_IW','TotalDirectCompensationTargetlessAllowancesBlackScholesMTCS_Perc75_OW','TotalDirectTarget_Perc75_IW','TotalDirectTarget_Perc75_OW','TotalDirectCompensationTargetlessAllowancesBlackScholes_Perc75_IW','TotalDirectCompensationTargetlessAllowancesBlackScholes_Perc75_OW','TotalDirectCompensationTargetlessAllowancesBlackScholesHourlyMTCS_Perc75_IW','TotalDirectCompensationTargetlessAllowancesBlackScholesHourlyMTCS_Perc75_OW'))
