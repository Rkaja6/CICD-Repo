...
INNER JOIN 
	...
	-- When hiring/terminations are mid-period...
	-- Start on the later of the Hire Date or the Period Start Date. End on the earlier of the Termination Date of the Period End Date
...
WHERE W.[Worker Type] = 'Employee'
AND W.Country = 'United States of America';

-- Insert Forecast of US Employee worked hours for current payroll period. Assume 8 hrs/day, business days only for full time, 4 hrs/day for part time.
INSERT INTO RPT.Worked_Hours_Detail
...
-- Insert non US-employee hours and contingent worker hours. Assume 8 hrs/day for full-time, 4 hrs/day for part-time.
-- Only Contractors get counted because Tellurian directs their day-to-day work. They are "employees" for OSHA record-keeping purposes.
...
SELECT
	...
	W.[Worker Status] AS WorkerStatus,
	W.Country,
	CASE W.[Contingent Worker Type]
		WHEN 'Contractor' THEN 'Company'
		WHEN null THEN 'Company'
		ELSE 'Other Workers'
	END AS WorkerType,
	W.[Location],
	W.Department,
